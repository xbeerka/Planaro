...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    // Removed Slot dependency to fix build errors.
    // If asChild is true, we ideally would merge props, but for now we'll render a button 
    // or just children if we could, but simplified to button for stability.
    const Comp = "button";
    return (
      <Comp
