import svgPaths from "./svg-v480ha5ztf";
...
function Paragraph() {
  return (
    <div className="content-stretch flex items-center overflow-clip px-[4px] py-0 relative shrink-0" data-name="Paragraph">
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start pb-0 pl-[5.531px] pr-[5.539px] pt-[7.531px] relative rounded-[4px] shrink-0 size-[20px]" data-name="Container">
      <div className="flex items-center justify-center relative shrink-0 w-full">
        <div className="flex-none rotate-[180deg] w-full">
          <ArrowUp1 />
        </div>
