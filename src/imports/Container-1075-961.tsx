  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start leading-[normal] relative w-full">
        <p className="font-['Onest:SemiBold',sans-serif] font-semibold min-w-full relative shrink-0 text-[#1a1a1a] text-[15px] w-[min-content]">Поделиться</p>
        <p className="font-['Onest:Regular',sans-serif] font-normal relative shrink-0 text-[#868789] text-[12px] whitespace-nowrap">Организация «Тестовая организация»</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#f6f6f6] flex-[166.531_0_0] h-[36px] min-h-px min-w-px relative rounded-[10px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pl-[12px] pr-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Onest:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px relative text-[#999] text-[13px]">Введите email</p>
        </div>
      </div>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-[#d6d6d6] h-[36px] relative rounded-[10px] shrink-0" data-name="Button">
