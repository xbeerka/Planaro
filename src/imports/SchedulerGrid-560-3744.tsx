import svgPaths from "./svg-0w0rzh67gh";
...
function Paragraph() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex items-center overflow-clip px-[4px] py-0 relative rounded-bl-[4px] rounded-tl-[4px] shrink-0" data-name="Paragraph">
...
function Container1() {
  return (
    <div className="bg-[#e2e2e2] content-stretch flex flex-col items-start pb-0 pl-[5.531px] pr-[5.539px] pt-[7.531px] relative rounded-br-[4px] rounded-tr-[4px] shrink-0 size-[20px]" data-name="Container">
      <div className="flex items-center justify-center relative shrink-0 w-full">
        <div className="flex-none rotate-[180deg] w-full">
          <ArrowUp1 />
        </div>
