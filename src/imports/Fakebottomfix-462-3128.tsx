...
function Frame() {
  return (
    <div className="box-border content-stretch flex items-start justify-between mb-[-1px] relative shrink-0 w-full">
      <LeftRound />
      <RightRound />
    </div>
  );
...
function Panel() {
  return (
    <div className="h-[10px] mb-[-1px] relative shrink-0 w-[276px]" data-name="panel">
